...
export interface ApiResumIdResumId extends Struct.CollectionTypeSchema {
  collectionName: 'resum_ids';
  info: {
    singularName: 'resum-id';
    pluralName: 'resum-ids';
    displayName: 'resumId';
    description: '';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::resum-id.resum-id': ApiResumIdResumId;
